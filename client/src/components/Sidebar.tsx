...
import { useAuthStore, useRolesStore, useUIStore, useEnvironmentStore, useChatStore } from '../store';
                ...
                <div className={`flex items-center rounded-lg text-sm transition-colors ${
                  ...
                  >
                    <div className="relative shrink-0">
                      <svg className="w-4 h-4" viewBox="0 0 611.998 611.998" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {unreadCounts[role.id] > 0 && currentRole?.id !== role.id && (
